...
CREATE TABLE `PEDIDOS` (
  ...
  PRIMARY KEY (`ID`),
  CONSTRAINT `fk_pedidos_producto_id`
    FOREIGN KEY (`PRODUCTO_ID`) REFERENCES `PRODUCTOS`(`ID`) ON DELETE CASCADE,
  CONSTRAINT `fk_pedidos_compra_id`
    FOREIGN KEY (`COMPRAS_ID`) REFERENCES `COMPRAS`(`ID`) ON DELETE CASCADE,
  CONSTRAINT `fk_pedidos_compra_usuario_id`
