...
INSERT INTO JUEGOS (NOMBRE, PRECIO, STOCK, DESCRIPCION, RUBRO_ID) VALUES
('TEG', 4000, NULL, 'Juego de estrategia por turnos donde los jugadores compiten por conquistar territorios en un mapa mundial. Ideal para sesiones largas y apasionantes entre amigos.', 4, 'images/teg.jpeg'),
('Ajedrez', 2500, NULL, 'Clásico juego de mesa de origen milenario que enfrenta a dos jugadores en una batalla de lógica, concentración y estrategia pura.', 7,'images/ajedrez.jpeg'),
('Monopoly', 3000, NULL, 'Divertido juego de compraventa de propiedades donde los jugadores compiten por construir imperios inmobiliarios y evitar la bancarrota.', 2, 'images/monopoly.png'),
...
('4 en línea', 1500, NULL, 'Juego rápido y sencillo donde dos jugadores intentan alinear cuatro fichas del mismo color antes que su oponente. Perfecto para todas las edades.', 7, 'images/4linea.jpeg'),
...
('Pictionary', 3500, NULL, 'Juego de mesa en el que los jugadores deben dibujar palabras o frases para que su equipo las adivine. Diversión asegurada para reuniones.', 2, 'images/pictionary.jpeg'),
...
('Damas', 2250, NULL, 'Juego de estrategia tradicional para dos jugadores donde el objetivo es capturar todas las piezas del oponente moviéndote en diagonal.', 7, 'images/damas.png'),
...
('Backgammon', 2199, NULL, 'Juego de mesa de origen antiguo que combina azar y estrategia. El objetivo es ser el primero en sacar todas las fichas del tablero.', 7, 'images/backgammon.jpeg'),
